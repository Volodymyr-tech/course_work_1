...
def test_calculate_expenses(mock_stock_rates, mock_get, df, start_date, end_date, expected_total):
    ...
    mock_get.return_value.json.return_value = {
        "rates": {"USD": 74.0, "EUR": 85.0, "GBP": 100.0}
    }
